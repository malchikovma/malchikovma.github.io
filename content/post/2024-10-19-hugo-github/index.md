...
> GitHub из коробки работает с Jekyll, но я уже потратил вечер на изучение Hugo, и он мне понравился.
...
Переходим в свежесозданную директорию, открываем ~~Vim~~ свой любимый редактор и создаем файл `index.html` с содержимым "Hello GitHub Pages!".
...
Hugo не может создать новый сайт в уже существующей директории, поэтому создаем его рядом, затем перемещаем в созданный ранее репозиторий.
