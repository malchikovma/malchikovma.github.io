...
У меня давно было желание создать свой сайт, но всегда отталкивали цены на хостинг, постоянные проблемы с CMS ~~и отсутствие идей~~. С SSG и GitHub Pages звезды, наконец, сошлись.

В статическом контенте масса преимуществ. В нем нет уязвимостей, как в классических CMS. Он занимает минимум места на диске. HTML-страницы открываются мгновенно. Хостинг на GitHub не требует финансовых вложений. Использование своего домена позволит мне "переехать" на другой хостинг в любой момент.

В день публикации первого поста, я рассказал об этом событии знакомому. Он спросил меня, как я это сделал? Я затруднился ответить: слишком много технических деталей нужно было объяснить. Для человека, не занимающегося разработкой ПО, генератор статических сайтов вряд ли подойдет. Слишком много нужно знать: Bash, Git, YAML, Markdown. Гораздо проще взять тот же WordPress и работать через GUI. Но если так получилось, что у вас уже есть такой "багаж", то почему бы и не воспользоваться им.
